export const programmingLanguage = [
    ...
    {
        id: 'pl-02',
        question: 'Qual das seguintes linguagens é conhecida por sua sintaxe concisa e é frequentemente utilizada para desenvolvimento web front-end?',
        answerOptions: ['Java', 'C++', 'Python', 'JavaScript'],
        correctAnswer: 'JavaScript',
    },
    {
        id: 'pl-03',
        question: 'Qual linguagem de programação é amplamente utilizada para o desenvolvimento de aplicativos móveis para iOS?',
    ...
    {
        id: 'pl-05',
        question: 'Qual linguagem de programação é conhecida por sua eficiência e é frequentemente utilizada para o desenvolvimento de sistemas operacionais e jogos?',
...
export const frontEnd = [
    {
        id: 'fe-01',
        question: 'Qual das seguintes linguagens é a base para a estrutura de um site, definindo sua hierarquia e conteúdo?',
    ...
    {
        id: 'fe-04',
        question: 'Qual framework JavaScript é amplamente utilizado para criar interfaces de usuário complexas e interativas?',
...
export const frameworks = [
    ...
    {
        id: 'f-02',
        question: 'Qual framework JavaScript é considerado mais leve e progressivo, permitindo uma adoção gradual em projetos existentes?',
...
export const javaScriptMethods = [
    {
        id: 'm-01',
        question: 'Qual método de array adiciona um ou mais elementos ao final de um array e retorna o novo comprimento do array?',
    ...
    {
        id: 'm-05',
        question: 'Qual método de array junta todos os elementos de um array em uma string, separando-os por um delimitador especificado?',
...
export const programming = [
    ...
    {
        id: 'p-02',
        question: 'Qual estrutura de controle permite repetir um bloco de código enquanto uma determinada condição for verdadeira?',
    ...
    },
    {
        ...
        correctAnswer: 'Sintaxe se refere à estrutura das frases, enquanto semântica se refere ao significado das palavras.',
    },
    {
        id: 'p-05',
        ...
        correctAnswer: 'A programação imperativa descreve como realizar uma tarefa, enquanto a declarativa descreve o resultado desejado.',
    },
];
export const nodejs = [
    {
        id: 'n-01',
        question: '1. Qual é a principal característica do Node.js que o diferencia de outros ambientes de execução JavaScript??',
        answerOptions: [
